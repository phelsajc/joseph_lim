export default {
  ...
  navbar: {
    logOut: 'Log Out',
    dashboard: 'Dashboard',
    changePasswordFieldCurrent: 'Current password',
    changePasswordFieldNew: 'New password',
    changePasswordFieldConfirm: 'Confirm new password',
    ...
    changePasswordMinLength: 'New password must be at least 6 characters',
    changePasswordMismatch: 'Passwords do not match',
    changePasswordSuccess: 'Your password has been updated successfully.',
    changePasswordFailed: 'Could not update password. Please try again.',
