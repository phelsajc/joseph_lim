export default {
  ...
  navbar: {
    logOut: 'Đăng xuất',
    dashboard: 'Dashboard',
    changePasswordFieldCurrent: 'Mật khẩu hiện tại',
    changePasswordFieldNew: 'Mật khẩu mới',
    changePasswordFieldConfirm: 'Xác nhận mật khẩu mới',
    changePassword: 'Đổi mật khẩu',
    changePasswordTitle: 'Đổi mật khẩu',
    changePasswordCurrentRequired: 'Vui lòng nhập mật khẩu hiện tại',
    changePasswordNewRequired: 'Vui lòng nhập mật khẩu mới',
    changePasswordConfirmRequired: 'Vui lòng xác nhận mật khẩu mới',
    changePasswordMinLength: 'Mật khẩu mới phải có ít nhất 6 ký tự',
    changePasswordMismatch: 'Mật khẩu xác nhận không khớp',
    changePasswordSuccess: 'Mật khẩu đã được cập nhật.',
    changePasswordFailed: 'Không thể cập nhật mật khẩu. Vui lòng thử lại.',
