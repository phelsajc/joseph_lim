export default {
  ...
  navbar: {
    logOut: 'Выход',
    dashboard: 'Панель управления',
    changePasswordFieldCurrent: 'Текущий пароль',
    changePasswordFieldNew: 'Новый пароль',
    changePasswordFieldConfirm: 'Подтверждение пароля',
    changePassword: 'Сменить пароль',
    changePasswordTitle: 'Смена пароля',
    changePasswordCurrentRequired: 'Введите текущий пароль',
    changePasswordNewRequired: 'Введите новый пароль',
    changePasswordConfirmRequired: 'Подтвердите новый пароль',
    changePasswordMinLength: 'Новый пароль — не менее 6 символов',
    changePasswordMismatch: 'Пароли не совпадают',
    changePasswordSuccess: 'Пароль успешно обновлён.',
    changePasswordFailed: 'Не удалось обновить пароль. Попробуйте снова.',
