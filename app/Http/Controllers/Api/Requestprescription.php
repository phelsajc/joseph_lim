...
class Requestprescription extends Fpdf
{
    private $data;
    private $widths;
    private $aligns;
    ...
    public function Body()
    {
        ...
        $this->Ln(1);
        $this->cell(30, 3, '', 0, 0);
        $this->MultiCell(90, 4, "Remarks:\n".strtoupper($this->data['type']==1?$this->data['appointment_detail']->lab_remarks:$this->data['appointment_detail']->ancillary_remarks), 'B', 'L');
    }
    ...
    public function Footer()
    {
        ...
        /* if ($this->data['dctr_details']->signature) {
            $this->Image($this->data['dctr_details']->signature, 260, 190, 40, 20, 'png');
        } */
        $this->cell(105, 3, "", '', 0, 'R');
        ...
        $this->cell(20, 3, $this->data['dctr_details']->validity_prc?date_format(date_create($this->data['dctr_details']->validity_prc),'F d,Y'):'', 'B', 1, 'R'); */
        /* $this->cell(20, 3, "", 'B', 1, 'R');
