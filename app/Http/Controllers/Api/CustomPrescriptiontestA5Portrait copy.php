...
class CustomPrescriptiontestA5Portrait extends Fpdf
{
    ...
    { 
        ...
        $this->SetFont('Arial', 'B', 8);
        $this->Cell(125, -50, strtoupper("CLINIC HOURS"), 0, 0, 'C');
        $this->Ln(5);
        $this->SetFont('Arial', '', 8);
        $this->Cell(230, -55, strtoupper("Mon - Fri - 10:00AM to 3:00 PM"), 0, 0, 'C');  
        $this->Ln(5);
        $this->Cell(223, -60, strtoupper("Sat /Holiday - 10:00AM to 12:00 PM"), 0, 0, 'C');  
        $this->Ln(5);
        ...
        $this->cell(8, 3, '','' ,0, 0);
        $this->cell(130, 4, $this->data['patient_detail']->address, 'B',0, 0);
        $this->Image(public_path() . '/img/rx.png', 20, 47, 9, 9, 'PNG');
    }
    ...
    public function Header()
    {
        ...
        $this->cell(8, 3, '','' ,0, 0);
        $this->cell(130, 4, $this->data['patient_detail']->address, 'B',0, 0);
        $this->Image(public_path() . '/img/rx.png', 10, 60, 9, 9, 'PNG');
    }
