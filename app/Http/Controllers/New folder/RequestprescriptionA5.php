...
class RequestprescriptionA5 extends Fpdf
{
    ...
    {
        $this->Image(public_path() . '/img/kp.png', 23, 1, 25, 25, 'PNG');
        $this->Image(public_path() . '/img/cp.jpg', 40, 6, 12, 12, 'JPG');
        $this->Ln(1);
        $this->SetFont('Arial', 'B', 9);
        $this->Cell(130, 3, strtoupper($this->data['profile']->name), 0, 0, 'R');
        ...
        $this->Cell(130, -17, strtoupper($this->data['profile']->specialization2), 0, 0, 'C');
        $this->Ln(10);
        $this->SetFont('Arial', '', 7);
        $this->SetXY(7, 14);
        $this->SetFont('Arial', 'B', 7);
